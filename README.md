...
In order to make sure that the game is accessible to people of different backgrounds and ages, I have created three personas, each with their own scenario. The first Persona is an inexperienced gamer who wants to learn how to play a moblie game in order to connect with her teenage daughters. It is very important for her to play a game with instructions. The second Persona is an experience gamer who likes to play games that not only have music but the allows the user to pick their own genre. Therefore, it is significant for her to find a game that gives the user some freedom over playlist. The last Persona is a gamer who is a UCLA shy teenager, looking for a way to reconnect with his highschool friends. Therefore, it is important for him to play a game that has a two-player feature. I hope that all of these personas and scenarios help individuals find diversity within the game so that it is versatile. [Find out More...](https://github.com/pandeynadia/nadia/tree/master/Assignment05:%20Persona%2BScenarios)
